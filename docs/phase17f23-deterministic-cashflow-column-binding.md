...
Correction: the historical pilot-reference claims below are superseded by [Phase 17F.23E](phase17f23e-correct-scope-local-header-rebaseline.md). Strauss 494.000 and Fox 235.354 are invalid consolidated FY2025 baselines and must not be used as regression expectations.
