...
Phase 9E completed Neto's deterministic coordinate-aware PDF fallback and centralized Globes daily-change normalization. Neto FY2025 cash, debt, CFO, explicit PP&E Capex, and D&A are source-backed; all five Globes absolute changes are canonical ILS while raw agorot values are preserved. See `docs/phase9e-neto-and-daily-change-fix.md`.
