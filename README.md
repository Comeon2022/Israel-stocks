...
Phase 1 of a Hebrew RTL financial-analysis dashboard for Israeli consumer and food companies. The app is a static prototype using structured mock data for Sano, Shufersal, Rami Levy, Yochananof, and Neto Malinda.
...
- `src/data`: structured mock companies and historical financials
