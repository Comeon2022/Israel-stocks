...
MAYA requests are shape-checked, retried up to three times with bounded backoff, paginated at a maximum page size of 30, and deduplicated. The CLI performs live XBRL download/structural checks in dry-run mode; financial activation remains validation-gated.
